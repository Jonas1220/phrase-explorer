...
export default function LangItem({langIso, lang}:{langIso:string, lang:string}) {
    return (
        <Link to={'/'+langIso} className='bg-slate-200 hover:bg-indigo-500 hover:text-white flex justify-between my-3 py-2 px-4 rounded-xl items-center ease-in transition-all'>
